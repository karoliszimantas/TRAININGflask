...
class DictLoader(BaseLoader):
    ...
    >>> loader = DictLoader({'admin_index.html': 'source here'})
...
class PrefixLoader(BaseLoader):
    ...
    By loading ``'app1/admin_index.html'`` the file from the app1 package is loaded,
    by loading ``'app2/admin_index.html'`` the file from the second.
    """
